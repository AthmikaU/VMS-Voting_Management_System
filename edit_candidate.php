...
// Fetch constituencies for the select dropdown
$constituencies_query = "SELECT constituency_id, constituency_name FROM constituencies";
...
<body>
    ...
    <div class="container form-container">
        ...
        <form action="update_candidate.php" method="POST">
            ...
            <button onclick="window.location.href='party.php'" class="btn btn-secondary ml-2">Cancel</button>
        </form>
    </div>
